...
bits = '1' * 32
a=int((ip_octets[3]).replace(ip_octets[3],'0'))
...
print(ip_template.format(int(ip_octets[0]), int(ip_octets[1]), int(ip_octets[2]), a, (short_mask), octet_a, octet_b, octet_c, octet_d))
